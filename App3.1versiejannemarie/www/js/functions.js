...
function selectBranch()
{
    ...
    for(i = 0; i < array.length; i++)
  {
    if(i % 2 === 0)
    {
      $("#allVacancies").append("<div id='vacancy"+ i +"' class='vacancy text'>"+ array[i][0] + "AAP" + "</div>");

      if(array[i][1] === "1")
      {
        $("#vacancy" + i).css("background-color", "#c7d320");
        $("#vacancy" + i).prepend("<img class='icon' src='img/Icons-06.png' alt='icon' height='50%'/>");
      }
      else if(array[i][1] === "2")
      {
